...
{
    public class MdHeadingElement : MarkdownHeading
    {
        private readonly int level;

        public MdHeadingElement(HeadingBlock headingBlock)
            : base(headingBlock)
        {
        ...
        private class HeadingTextFlowContainer : MarkdownTextFlowContainer
        {
