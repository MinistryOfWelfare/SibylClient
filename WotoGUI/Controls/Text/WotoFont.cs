...
namespace WotoGUI.Controls.Text
{
    ...
    public static class OsuFontExtensions
    {
        ...
        {
            string familyString = typeface != null ? WotoFont.GetFamilyString(typeface.Value) : usage.Family;
            string weightString = weight != null ? WotoFont.GetWeightString(familyString, weight.Value) : usage.Weight;
