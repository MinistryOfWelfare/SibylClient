...
namespace WotoGUI.Controls.UI
{
        ...
        where T : struct, IEquatable<T>
    {
        ...
        /// <summary>
        /// Creates an <see cref="SpriteTextElement"/> which may be used to display this counter's text.
        /// May not be called if <see cref="CreateText"/> is overridden.
        /// </summary>
        protected virtual SpriteTextElement CreateSpriteText() => new SpriteTextElement
        {
            Font = WotoFont.Numeric.With(size: 40f),
        };
    }
}
