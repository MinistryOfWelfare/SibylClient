...
namespace SibylClient.Configuration
{
	...
	public sealed class JConfig
	{
		...
		[JsonPropertyName("wp-server")]
		public WpHostInfo WpHostInfo { get; set; }
		
		[JsonPropertyName("sv-server")]
		public SvHostInfo SvHostInfo { get; set; }
		#endregion
		//-------------------------------------------------
		...
		public static JConfig Parse(string data) =>
			JsonSerializer.Deserialize<JConfig>(data);
